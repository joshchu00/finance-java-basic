...
public class ChoosingStockResultPrimaryKey implements PrimaryKey, Serializable {

	private static final long serialVersionUID = -6444581638662650765L;
	
	private String today;//yyyyMMdd
    private Short cssid;
    private String symbol;
    
	public ChoosingStockResultPrimaryKey(String today, Short cssid,
			String symbol) {
		super();
		this.today = today;
		this.cssid = cssid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChoosingStockResultPrimaryKey other = (ChoosingStockResultPrimaryKey) obj;
		if (cssid == null) {
			if (other.cssid != null)
				return false;
